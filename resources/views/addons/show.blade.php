            ...
            <div class="lg:col-span-3" data-aos="fade-right">
                ...
                <div id="addon-gallery-lightbox" class="fixed inset-0 z-[9999] hidden items-center justify-center bg-black/55 backdrop-blur-xl p-6 sm:p-10" onclick="closeAddonGallery()">
                    <div class="relative flex h-full w-full items-center justify-center" onclick="event.stopPropagation()">
                        <img id="addon-gallery-img" src="" alt="Full view" class="h-auto w-auto max-w-[95vw] max-h-[85vh] rounded-2xl object-contain select-none border border-white/10 shadow-2xl shadow-black/60 transition-opacity duration-200 md:max-w-[90vw] md:max-h-[80vh] lg:max-w-[85vw] lg:max-h-[78vh] xl:max-w-[80vw] xl:max-h-[75vh]">
                    </div>
