...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 mt-20" id="hero">
    {{-- Animated Background --}}
                ...
                <div class="aspect-video bg-gradient-to-br from-purple-900/20 to-gray-800 overflow-hidden relative">
                    ...
                    <div class="absolute top-3 right-3">
                        ...
                        <span class="glass text-amber-300 text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1.5">
                            ...
                            <span class="line-through text-white/45 font-medium">${{ number_format($addon->original_price, 2) }}</span>
                            @endif
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs text-gray-500 flex items-center gap-1">
                            ...
                            {{ number_format(90 + $article->views_count) }}
                        </span>
                    </div>
                    <h3 class="text-lg font-semibold mt-2 group-hover:text-purple-400 transition-colors">{{
                        $article->title }}</h3>
