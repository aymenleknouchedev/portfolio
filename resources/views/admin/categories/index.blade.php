...
@section('page_title', 'Add-on Categories')
@section('page_subtitle', $categories->count() . ' ' . Str::plural('category', $categories->count()))

@section('content')
<div class="flex items-center justify-between mb-6 gap-4 flex-wrap">
    <p class="text-sm text-gray-400">Organize your add-ons into browsable groups.</p>
        ...
        <table class="w-full text-sm min-w-[640px]">
            <thead>
                <tr class="text-gray-400 text-left text-xs uppercase tracking-wider">
                    ...
                    <th class="px-6 py-4 font-medium">Add-ons</th>
                ...
                <tr class="transition-colors">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 rounded-lg bg-gradient-to-br from-purple-500/30 to-violet-700/20 border border-purple-500/20 flex items-center justify-center">
                    ...
                    <td class="px-6 py-4">
                        <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-semibold bg-white/5 border border-white/10">{{ $category->addons_count }}</span>
                    </td>
                    <td class="px-6 py-4">
