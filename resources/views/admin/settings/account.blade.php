...
@section('page_subtitle', 'Update your admin email and password')
...
<div>
    ...
    <form action="{{ route('admin.settings.account.update') }}" method="POST" class="space-y-8">
        ...
        <div class="flex justify-end">
            <button type="submit" class="bg-purple-600 hover:bg-purple-500 text-white text-sm font-medium px-8 py-3 rounded-xl transition-all hover: hover:">
                Save Changes
            </button>
        </div>
    </form>
